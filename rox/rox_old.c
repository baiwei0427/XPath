...
int init_module()
{
	...
	//PREROUTING
	nfho_incoming.hook = hook_func;                       //function to call when conditions below met
	...
	//POSTROUTING
	nfho_outgoing.hook = hook_func;                       //function to call when conditions below met
